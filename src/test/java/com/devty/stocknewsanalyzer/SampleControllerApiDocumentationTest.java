...
import com.devty.stocknewsanalyzer.collection.controller.NewsController;
import com.devty.stocknewsanalyzer.collection.entity.Sample;
...
public class SampleControllerApiDocumentationTest {
    ...
    @Mock
    private NewsService sampleService;

    @InjectMocks
    private NewsController sampleController;
